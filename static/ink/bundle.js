...
AboutPage = () => h(__Ink_String(`div`), [__Ink_String(`aboutPage`)], [h(__Ink_String(`h1`), [], [__Ink_String(`About Ink playground`)]), h(__Ink_String(`p`), [], [__Ink_String(`some explanation`)])]);
...
render = () => update(h(__Ink_String(`div`), [__Ink_String(`app`)], [__ink_match(Embedded__ink_qm__, [[() => (true), () => (null)], [() => (__Ink_Empty), () => (Header())]]), __ink_match((() => {let __ink_acc_trgt = __as_ink_string(State); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[page] || null : (__ink_acc_trgt.page !== undefined ? __ink_acc_trgt.page : null)})(), [[() => ((() => {let __ink_acc_trgt = __as_ink_string(Page); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[Home] || null : (__ink_acc_trgt.Home !== undefined ? __ink_acc_trgt.Home : null)})()), () => (h(__Ink_String(`div`), [__Ink_String(`workspace`)], [Editor(), Repl()]))], [() => ((() => {let __ink_acc_trgt = __as_ink_string(Page); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[About] || null : (__ink_acc_trgt.About !== undefined ? __ink_acc_trgt.About : null)})()), () => (AboutPage())]]), Credits()]));
render()
