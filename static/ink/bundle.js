...
State = {file: __ink_match(restored = getItem(__Ink_String(`State.file`)), [[() => (null), () => ((() => {let __ink_acc_trgt = __as_ink_string(Examples); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[Hello] || null : (__ink_acc_trgt.Hello !== undefined ? __ink_acc_trgt.Hello : null)})())], [() => (__Ink_Empty), () => (restored)]]), line: __Ink_String(``), replLines: [], theme: __Ink_String(`light`), exampleName: __Ink_String(``)};
