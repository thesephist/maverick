...
AboutPage = () => h(__Ink_String(`div`), [__Ink_String(`aboutPage`)], [h(__Ink_String(`div`), [__Ink_String(`aboutContent`)], [h(__Ink_String(`h1`), [], [__Ink_String(`About the playground`)]), h(__Ink_String(`p`), [], [__Ink_String(`The Ink playground is a web based IDE and REPL for the `), Link(__Ink_String(`Ink`), __Ink_String(`https://dotink.co/`)), __Ink_String(` programming language.`)])])]);
...
State = {file: __ink_match(restored = getItem(__Ink_String(`State.file`)), [[() => (null), () => ((() => {let __ink_acc_trgt = __as_ink_string(Examples); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[__Ink_String(`Hello World`)] || null : (__ink_acc_trgt[__Ink_String(`Hello World`)] !== undefined ? __ink_acc_trgt[__Ink_String(`Hello World`)] : null)})())], [() => (__Ink_Empty), () => (restored)]]), line: __Ink_String(``), replLines: [], exampleName: __Ink_String(``), theme: __Ink_String(`light`), page: (() => {let __ink_acc_trgt = __as_ink_string(Page); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[Home] || null : (__ink_acc_trgt.Home !== undefined ? __ink_acc_trgt.Home : null)})()};
...
render = () => update(h(__Ink_String(`div`), [__Ink_String(`app`), (() => {let __ink_acc_trgt = __as_ink_string(State); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[theme] || null : (__ink_acc_trgt.theme !== undefined ? __ink_acc_trgt.theme : null)})()], [__ink_match(Embedded__ink_qm__, [[() => (true), () => (null)], [() => (__Ink_Empty), () => (Header())]]), __ink_match((() => {let __ink_acc_trgt = __as_ink_string(State); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[page] || null : (__ink_acc_trgt.page !== undefined ? __ink_acc_trgt.page : null)})(), [[() => ((() => {let __ink_acc_trgt = __as_ink_string(Page); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[Home] || null : (__ink_acc_trgt.Home !== undefined ? __ink_acc_trgt.Home : null)})()), () => (h(__Ink_String(`div`), [__Ink_String(`workspace`)], [Editor(), Repl()]))], [() => ((() => {let __ink_acc_trgt = __as_ink_string(Page); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[About] || null : (__ink_acc_trgt.About !== undefined ? __ink_acc_trgt.About : null)})()), () => (AboutPage())]]), Credits()]));
render()
