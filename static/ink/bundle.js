...
scrollToReplEnd = () => (() => { let repl; return __ink_match(repl = bind(document, __Ink_String(`querySelector`))(__Ink_String(`.repl`)), [[() => (null), () => (null)], [() => (__Ink_Empty), () => ((() => {let __ink_assgn_trgt = __as_ink_string(repl); __is_ink_string(__ink_assgn_trgt) ? __ink_assgn_trgt.assign(scrollTop, (() => {let __ink_acc_trgt = __as_ink_string(repl); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[scrollHeight] || null : (__ink_acc_trgt.scrollHeight !== undefined ? __ink_acc_trgt.scrollHeight : null)})()) : (__ink_assgn_trgt.scrollTop) = (() => {let __ink_acc_trgt = __as_ink_string(repl); return __is_ink_string(__ink_acc_trgt) ? __ink_acc_trgt.valueOf()[scrollHeight] || null : (__ink_acc_trgt.scrollHeight !== undefined ? __ink_acc_trgt.scrollHeight : null)})(); return __ink_assgn_trgt})())]]) })();
